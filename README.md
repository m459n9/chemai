...
Эксперименты документировались в отдельной research-тетради (grid-search +
Optuna по всем комбинациям FE / dedup / aug / cascade) — финальный
пайплайн оставил только подтверждённые на public LB техники.
...
- [x] Ноутбук работает с данными в корне репозитория (как в этом репо) или
      в подпапке `./data/` — путь определяется автоматически.
